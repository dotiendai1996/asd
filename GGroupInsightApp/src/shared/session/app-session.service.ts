...
import { ApplicationInfoDto, GetCurrentLoginInformationsOutput, SessionServiceProxy, TenantLoginInfoDto, UserLoginInfoDto, UiCustomizationSettingsDto } from '../service-proxies/service-proxies';
...
export class AppSessionService {
    ...
    getShownLoginName(): string {
        const userName =this._user.surname +''+ this._user.userName;
