...
import { UiCustomizationSettingsDto, TruongGiaoDichsServiceProxy, UserLoginInfoDto } from '@shared/service-proxies/service-proxies';
...
export abstract class AppComponentBase {
    ...
    truongGiaoDichService: TruongGiaoDichsServiceProxy;
    ...
    constructor(injector: Injector) {
        ...
        this.truongGiaoDichService = injector.get(TruongGiaoDichsServiceProxy);
    }

    getAllTruongGiaoDich(){
        return this.truongGiaoDichService.getAllTruongGiaoDich();
    }
    ...
    getFullNameCurrentUser(): string {
        return this.appSession.user.surname + ' ' + this.appSession.user.name;
    }
    ...
    isNumber(event){
        ...
        if ((event.event.key === ' ' || isNaN(Number(event.event.key))) 
